...
class CheckDepoiset(models.TransientModel):
    ...
    def action_depoiset(self):
        ...
        debit_notes_account = check_rec.payment_id.journal_id.default_debit_account_id.id
        ...
        if move:
            ...
            check_rec.check_under_col = self.debit_journal_id.default_debit_account_id.id
